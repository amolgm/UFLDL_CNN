...
load ../data/stlSubset/stlTrainSubset.mat % loads numTrainImages, trainImages, trainLabels
load ../data/stlSubset/stlTestSubset.mat  % loads numTestImages,  testImages,  testLabels
...
save('../results/cnnPooledFeatures.mat', 'pooledFeaturesTrain', 'pooledFeaturesTest');
toc();
